...
L.Control.GroupedLayers = L.Control.extend({
    ...
    options: {
        collapsed: true, position: 'topright', autoZIndex: true, exclusiveGroups: [], groupCheckboxes: false
    },
    ...
    _addLayer: function (layer, name, group, overlay) {
        ...
        _layer.group = {
            name: group, id: groupId, exclusive: exclusive
        };
    ...
    _onLayerChange: function (e) {
        var obj = this._getLayer(L.Util.stamp(e.layer)), type;
